...
| ---------- | --------------------- | -------- | ------- | ------ | ----------- | ------------------------------------------------------------------- |
| Qwen3-Omni | thinker-only, ci-50, c=8 | 68.00%   | 34/50   | 0      | 0           | dirty 1665ec6 [H200, c=8, max_tokens=256] |
| Qwen3-Omni | thinker-talker, ci-10, c=8 | 68.00%   | 34/50   | 0      | 0           | dirty 1665ec6 [H200, c=8, max_tokens=256] |
...
| ---------- | --------------------- | --------- | ------ | -------------- | ---------------- | ------------- | ------------- | -------------- | ------------- | --------------- | ---------------- | ------------------ | ------------------- | -------------- | ------------------------------------------------------------------- |
| Qwen3-Omni | thinker-only, ci-50, c=8 | 50        | 0      | 48.455         | 51.020           | 57.252        | 58.074        | 1.0            | 0.9           | 44.0            | 2206             | 21684.0            | 1084218             | 0.153          | dirty 1665ec6 [H200, c=8, max_tokens=256] |
| Qwen3-Omni | thinker-talker, ci-10, c=8 | 50        | 0      | 44.091         | 40.910           | 61.393        | 107.512       | 1.1            | 1.0           | 44.0            | 2216             | 21684.0            | 1084218             | 0.159          | dirty 1665ec6 [H200, c=8, max_tokens=256] |
...
| ---------- | ------------------------- | --------- | ------- | ---------- | ------------------- | ------------------ | ------------------ | ------------------ | -------- | --------------------- | ------------------------------------------------------------------- |
| Qwen3-Omni | thinker-talker, ci-10, c=8 | 50/50     | 0       | 5.06%      | 11.61%              | 91.89%             | 200.00%            | 4                  | 6.3183   | 13.863                | dirty 1665ec6 [H200, c=8, max_tokens=256] |
...
No local v1 thinker-talker rerun was logged for the `ci-10` subset.
"""
